...
function getRotationAtBezierT(segment, i, t) {
  ...
  b += (c - b) * t;
  a += (b - a) * t;
  return _round3(_atan2(b + (c + (segment[i + 7] - c) * t - b) * t - a, x) * _RAD2DEG);
}
...
var MotionPathPlugin = {
  ...
  register: function register2(core, Plugin, propTween) {
    ...
    _getStyleSaver2 = gsap2.core.getStyleSaver;
    _reverting2 = gsap2.core.reverting || function() {
    };
    PropTween = propTween;
  },
...
_getGSAP3() && gsap2.registerPlugin(MotionPathPlugin);

// src/utils/svgScroll.ts
gsapWithCSS.registerPlugin(DrawSVGPlugin, MotionPathPlugin);
