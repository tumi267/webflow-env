...
var webflowEnv = (() => {
  ...
  var fade_in = document.getElementsByClassName("fade_in");
  var flipReveal = document.getElementsByClassName("flip_reveal");
  var pan = document.getElementsByClassName("pan");
  var roll_reveal = document.getElementsByClassName("roll_reveal");
  var rollRevealReverse = document.getElementsByClassName("roll_reveal_revese");
  var slide_in_left = document.getElementsByClassName("slide_in_left");
  var slide_in_right = document.getElementsByClassName("slide_in_right");
  ...
  var fade_element = document.getElementsByClassName("fade-element");
  var slide_in_left_scroll = document.getElementsByClassName("slide-in-left-scroll");
  var slide_in_right_scroll = document.getElementsByClassName("slide-in-right-scroll");
  var scale_up_scroll = document.getElementsByClassName("scale-up-scroll");
  var rotate_scroll = document.getElementsByClassName("rotate-scroll");
  var stagger_item_scroll = document.getElementsByClassName("stagger-item-scroll");
  var pin_element_scroll = document.getElementsByClassName("pin");
  var color_change_scroll = document.getElementsByClassName("color-change-scroll");
  var toggle_element_scroll = document.getElementsByClassName("toggle-element-scroll");
  var progress_bar_scroll = document.getElementsByClassName("progress-bar-scroll");
  ...
  var container_horizontal = document.getElementsByClassName("container_horizontal");
  var svg_contain = document.getElementsByClassName("svg_contain");
  var panel_wrapper = document.getElementsByClassName("panel-wrapper");
  var Contextual = document.getElementsByClassName("Contextual");
